        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<CaLam>(entity =>
            {
                entity.HasKey(e => e.MaCa)
                    .HasName("PK__CaLam__27258E7B01B82B6E");
            ...
            modelBuilder.Entity<HoaDon>(entity =>
            {
                entity.HasKey(e => e.MaHoaDon)
                    .HasName("PK__HoaDon__835ED13B81E83819");
            ...
            modelBuilder.Entity<HoaDonChiTiet>(entity =>
            {
                entity.HasKey(e => new { e.MaHoaDon, e.MaMonAn })
                    .HasName("PK__HoaDonCh__C84FA0590890969F");
            ...
            modelBuilder.Entity<KhachHang>(entity =>
            {
                entity.HasKey(e => e.MaKhachHang)
                    .HasName("PK__KhachHan__88D2F0E5A0010422");
            ...
            modelBuilder.Entity<MayTinh>(entity =>
            {
                entity.HasKey(e => e.MaMay)
                    .HasName("PK__MayTinh__3A5BBB415C121B23");
            ...
            modelBuilder.Entity<NhanVien>(entity =>
            {
                entity.HasKey(e => e.MaNhanVien)
                    .HasName("PK__NhanVien__77B2CA4712C7537E");
            ...
            modelBuilder.Entity<ThucDon>(entity =>
            {
                entity.HasKey(e => e.MaMonAn)
                    .HasName("PK__ThucDon__B117162576E4B474");
            ...
            modelBuilder.Entity<VaiTro>(entity =>
            {
                entity.HasKey(e => e.MaVaiTro)
                    .HasName("PK__VaiTro__C24C41CF9828CC3C");
